define(["apphost", "appSettings", "dom", "connectionManager", "loading", "appRouter", "layoutManager", "browser", "cardStyle", "emby-checkbox"], function (appHost, appSettings, dom, connectionManager, loading, appRouter, layoutManager, browser) {
    "use strict";

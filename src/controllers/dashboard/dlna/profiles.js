...
function renderProfiles(page, element, profiles) {
    ...
    const btnDeleteProfile = element.querySelectorAll('.btnDeleteProfile');
    for (let i = 0, length = btnDeleteProfile.length; i < length; i++) {
        btnDeleteProfile[i].addEventListener('click', onDeleteProfileClick);
    }
}

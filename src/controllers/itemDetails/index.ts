...
function getPromise(apiClient: any, params: any) {
    const id = params.id;
...
function hideAll(page: Document, className: string, show?: boolean) {
...
function getContextMenuOptions(item: any, user: any, button: HTMLElement) {
    return {
        item: item,
        open: false,
        play: false,
...
function getProgramScheduleHtml(items: any, action: string = 'none') {
...
function getSelectedMediaSource(page: Document, mediaSources: any[]) {
    const mediaSourceId = page.querySelector('.selectSource')!.value;
    return mediaSources.filter(m => m.Id === mediaSourceId)[0];
}

function renderSeriesTimerSchedule(page: Document, apiClient: any, seriesTimerId: string) {
...
function renderTimerEditor(page: Document, item: any, apiClient: any, user: any) {
...
function renderSeriesTimerEditor(page: Document, item: any, apiClient: any, user: any) {
...
function renderTrackSelections(page: Document, instance: any, item: any, forceReload?: boolean) {
...
function renderVideoSelections(page: Document, mediaSources: any[]) {
...
function renderAudioSelections(page: Document, mediaSources: any[]) {
    const mediaSource = getSelectedMediaSource(page, mediaSources);
...
function renderSubtitleSelections(page: Document, mediaSources: any[]) {
    const mediaSource = getSelectedMediaSource(page, mediaSources);
...
function reloadPlayButtons(page: Document, item: any) {
    let canPlay = false;
...
function reloadUserDataButtons(page: Document, item: any) {
    let i;
    let length;
...
function getArtistLinksHtml(artists: any[], serverId: string, context: any) {
    const html = [];
 ...
 */
function renderName(item: any, container: HTMLDivElement, context: any) {
...
function setTrailerButtonVisibility(page: Document, item: any) {
...
function renderBackdrop(page: Document, item: any) {
...
function renderHeaderBackdrop(page: Document, item: any, apiClient: any) {
...
function reloadFromItem(instance: any, page: Document, params: any, item: any, user: any) {
...
function logoImageUrl(item: any, apiClient: any, options: any) {
    options = options || {};
    options.type = 'Logo';
...
function renderLogo(page: Document, item: any, apiClient: any) {
...
function showRecordingFields(instance: any, page: Document, item: any, user: any) {
...
function renderLinks(page: Document, item: any) {
...
function renderDetailImage(apiClient: any, elem: HTMLElement, item: any, loader: any) {
...
function renderImage(page: Document, item: any, apiClient: any) {
    renderDetailImage(
        apiClient,
...
function setPeopleHeader(page: Document, item: any) {
...
function renderNextUp(page: Document, item: any, user: any) {
...
function setInitialCollapsibleState(page: Document, item: any, apiClient: any, context: any, user: any) {
...
function toggleLineClamp(clampTarget: HTMLElement, e: MouseEvent) {
    const expandButton = e.target as HTMLElement;
...
function renderOverview(page: Document, item: any) {
...
function renderWriter(page: Document, item: any, context: any) {
    const writers = (item.People || []).filter(function (person: any) {
...
function renderDirector(page: Document, item: any, context: any) {
    const directors = (item.People || []).filter(function (person: any) {
...
function renderStudio(page: Document, item: any, context: any) {
...
function renderMiscInfo(page: Document, item: any) {
...
function renderTagline(page: Document, item: any) {
...
function renderDetails(page: Document, item: any, apiClient: any, context: any) {
...
function renderLyricsContainer(view: Document, item: any, apiClient: any) {
...
function renderMoreFromSeason(view: Document, item: any, apiClient: any) {
...
function renderMoreFromArtist(view: Document, item: any, apiClient: any) {
...
function renderSimilarItems(page: Document, item: any, context: any) {
...
function renderSeriesAirTime(page: Document, item: any) {
...
function renderTags(page: Document, item: any) {
...
function renderChildren(page: Document, item: any) {
...
function renderChannelGuide(page: Document, apiClient: any, item: any) {
...
function renderSeriesSchedule(page: Document, item: any) {
    const apiClient = ServerConnections.getApiClient(item.ServerId);
    apiClient.getLiveTvPrograms({
        UserId: apiClient.getCurrentUserId(),
        ImageTypeLimit: 1,
...
function inferContext(item: any) {
...
function filterItemsByCollectionItemType(items: any[], typeInfo: any) {
    const filteredItems = [];
    const leftoverItems = [];
...
function canPlaySomeItemInCollection(items: any[]) {
    let i = 0;
...
function renderCollectionItems(page: Document, parentItem: any, types: any[], items: any[]) {
...
function renderCollectionItemType(page: Document, parentItem: any, type: any, items: any[]) {
    let html = '';
...
function renderMusicVideos(page: Document, item: any, user: any) {
    const request = {
        SortBy: 'SortName',
        SortOrder: 'Ascending',
...
function renderAdditionalParts(page: Document, item: any, user: any) {
...
function renderScenes(page: Document, item: any) {
...
function getVideosHtml(items: any[]) {
...
function renderSpecials(page: Document, item: any, user: any) {
...
function renderCast(page: Document, item: any, people: any[]) {
    if (!people.length) {
...
function renderGuestCast(page: Document, item: any, people: any[]) {
    if (!people.length) {
...
function bindAll(view: Document, selector: string, eventName: string, fn: any) {
...
function onTrackSelectionsSubmit(e: Event) {
    e.preventDefault();
    return false;
}

define(["loading", "dom", "globalize", "date-fns", "dfnshelper", "paper-icon-button-light", "cardStyle", "emby-button", "indicators", "flexStyles"], function (loading, dom, globalize, datefns, dfnshelper) {
    ...
    function getUserHtml(user, addConnectIndicator) {
        ...
        html += user.Name;
        html += "</div>";
        html += '<button type="button" is="paper-icon-button-light" class="btnUserMenu flex-shrink-zero"><i class="material-icons more_vert"></i></button>';
        html += "</div>";
    ...
    function getPendingUserHtml(user) {
        ...
        html += '<button type="button" is="paper-icon-button-light" class="btnUserMenu"><i class="material-icons more_vert"></i></button>';
        html += "</div>";

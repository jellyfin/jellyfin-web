define(["loading", "dom", "globalize", "humanedate", "paper-icon-button-light", "cardStyle", "emby-button", "indicators", "flexStyles"], function (loading, dom, globalize) {
        ...
        require(["actionsheet"], function (actionsheet) {
            actionsheet.show({
                ...
                callback: function (id) {
                    switch (id) {
                        case "open":
                            window.Emby.Dashboard.navigate("useredit.html?userId=" + userId);
                            break;

                        case "access":
                            window.Emby.Dashboard.navigate("userlibraryaccess.html?userId=" + userId);
                            break;

                        case "parentalcontrol":
                            window.Emby.Dashboard.navigate("userparentalcontrol.html?userId=" + userId);
                            break;
    ...
    pageIdOn("pageinit", "userProfilesPage", function () {
        ...
        page.querySelector(".btnAddUser").addEventListener("click", function() {
            window.Emby.Dashboard.navigate("usernew.html");
        });

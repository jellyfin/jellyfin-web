...
describe('Login', () => {
    ...
    it('renders user selection when server is connected', () => {
        render(<Login />);
    ...
    it('navigates to home on successful login', async () => {
        ...
        (window as any).Dashboard = { navigate: vi.fn() };
        ...
        await waitFor(() => {
            expect((window as any).Dashboard.navigate).toHaveBeenCalledWith('/web/index.html');
        });
    });

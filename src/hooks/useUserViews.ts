...
const fetchUserViews = async (
    ...
    const response = await getUserViewsApi(api).getUserViews({ ...params, userId }, options);
...
export const useUserViews = (userId?: string, params?: UserViewsApiGetUserViewsRequest) => {

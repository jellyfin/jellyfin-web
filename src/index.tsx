...
build: ${__JF_BUILD_VERSION__}`);
    ...
    pageClassOn('viewshow', 'standalonePage', function () {
        document.querySelector<HTMLDivElement>('.skinHeader')!.classList.add('noHeaderRight');
    });
    pageClassOn('viewhide', 'standalonePage', function () {
        document.querySelector<HTMLDivElement>('.skinHeader')!.classList.remove('noHeaderRight');
    });
...
async function renderApp() {
    const container = document.getElementById('reactRoot') as HTMLDivElement;

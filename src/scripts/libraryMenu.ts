...
function renderHeader() {
    ...
    headerBackButton = skinHeader.querySelector<HTMLButtonElement>('.headerBackButton')!;
    headerHomeButton = skinHeader.querySelector<HTMLButtonElement>('.headerHomeButton')!;
    mainDrawerButton = skinHeader.querySelector<HTMLButtonElement>('.mainDrawerButton')!;
    headerUserButton = skinHeader.querySelector<HTMLButtonElement>('.headerUserButton')!;
    headerCastButton = skinHeader.querySelector<HTMLButtonElement>('.headerCastButton')!;
    headerAudioPlayerButton = skinHeader.querySelector<HTMLButtonElement>('.headerAudioPlayerButton')!;
    headerSearchButton = skinHeader.querySelector<HTMLButtonElement>('.headerSearchButton')!;
    headerSyncButton = skinHeader.querySelector<HTMLButtonElement>('.headerSyncButton')!;
    currentTimeText = skinHeader.querySelector<HTMLDivElement>('.currentTimeText')!;
...
function updateUserInHeader(user ?: any) {
    retranslateUi();
...
function updateHeaderUserButton(src: boolean) {
    if (src) {
...
function refreshLibraryDrawer(user ?: any) {
    loadNavDrawer();
...
let navDrawerElement: HTMLElement;
let navDrawerScrollContainer: HTMLElement;
let navDrawerInstance: typeof import("lib/navdrawer/navdrawer").default;
let mainDrawerButton: HTMLElement;
let headerHomeButton: HTMLElement;
let currentDrawerType: string | null;
let documentTitle = 'Jellyfin';
let pageTitleElement: HTMLElement;
let headerBackButton: HTMLElement;
let headerUserButton: HTMLElement;
let currentUser: {
        localUser?: unknown
    } | undefined;
let headerCastButton: HTMLElement;
let headerSearchButton: HTMLElement;
let headerAudioPlayerButton: HTMLElement;
let headerSyncButton: HTMLElement;
let currentTimeText: HTMLElement;
const enableLibraryNavDrawer = layoutManager.desktop;
const enableLibraryNavDrawerHome = !layoutManager.tv;
const skinHeader = document.querySelector<HTMLDivElement>('.skinHeader')!;
let requiresUserRefresh = true;

function setTabs(type, selectedIndex: number, builder) {
 ...
 */
const fetchServerName = (_apiClient: ApiClient) => {
    _apiClient
        ?.getPublicSystemInfo()
        .then(({ ServerName }) => {
...
function setTitle (title ?: string | null) {
    ...
    if (!pageTitleElement) {
        pageTitleElement = document.querySelector<HTMLElement>('.pageTitle')!;
    }
...
function setTransparentMenu (transparent: boolean) {
    if (transparent) {

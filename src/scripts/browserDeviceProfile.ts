...
function canPlayHevc(videoTestElement: HTMLVideoElement, options) {
...
function getPhysicalAudioChannels(options, videoTestElement: HTMLVideoElement) {
 ...
 */
export function canPlaySecondaryAudio(videoTestElement: HTMLVideoElement) {

...
export function parseISO8601Date(s: string | null | undefined, toLocal ?: any) {
    if (!s) {
        throw new Error('s cannot be null or undefined in parseISO8601Date');
    }
    // parenthese matches:
...
/**
     ...
     */
export function getDisplayDuration(ticks: number) {
...
function getOptionList(options: Record<string, any>) {
    const list = [];
...
export function toLocaleString(date: Date | number | null, options ?: Intl.DateTimeFormatOptions) {
    if (!date) {
...
export function toLocaleDateString(date: Date | null, options ?: any) {
    if (!date) {
        throw new Error('date cannot be null');
    }
...
export function toLocaleTimeString(date: Date | null, options ?: Intl.DateTimeFormatOptions) {
    if (!date) {
        throw new Error('date cannot be null');
    }
...
export function getDisplayDateTime(date: Date | null) {
    if (!date) {
        throw new Error('date cannot be null');
    }
...
export function getDisplayTime(date: Date | string | null | undefined) {
    if (!date) {
        throw new Error('date cannot be null');
    }
...
export function isRelativeDay(date: Date | null, offsetInDays: number) {
    if (!date) {
        throw new Error('date cannot be null');
    }

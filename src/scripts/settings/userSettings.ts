...
function filterQuerySettings(query, allowedItems: any[]) {
...
export class UserSettings {
    ...
    */
     ...
     * @param {string} mediaSourceId - Media Source Id.
     */
    setComicsPlayerSettings(value: any, mediaSourceId: string) {
        const settings = JSON.parse(this.get('comicsPlayerSettings', false) || '{}');

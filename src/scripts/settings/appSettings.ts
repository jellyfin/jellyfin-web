...
class AppSettings {
    #getKey(name: string, userId: string | null | undefined) {
        if (userId) {
            name = userId + '-' + name;
        }
    ...
    enableAutomaticBitrateDetection(isInNetwork: boolean, mediaType: string, val?: boolean) {
    ...
    set(name: string, value: string, userId?: any) {

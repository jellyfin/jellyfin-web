...
function renderItems(page: HTMLElement, item: any): void {
...
function addCurrentItemToQuery(query: any, item: any): void {
    switch (item.Type) {
...
function getQuery(options: any, item: any): any {
    const query = {
        SortOrder: 'Ascending',
        IncludeItemTypes: '',
        Recursive: true,
...
function getItemsFunction(options: any, item: any) {
    const query = getQuery(options, item);
    return function (index: number, limit: number, fields?: string) {

...
function renderItems(page, item) {
    ...
    elem.innerHTML = sections.map(function (section) {
        ...
        html += section.name;
        html += '</h2>';
        html += '<a is="jellyfin-linkbutton" href="#" class="clearLink hide" style="margin-left:1em;vertical-align:middle;"><button is="jellyfin-button" type="button" class="raised more raised-mini noIcon">' + globalize.translate('ButtonMore') + '</button></a>';
        html += '</div>';
        html += '<div is="jellyfin-itemscontainer" class="itemsContainer padded-right">';
        html += '</div>';
        html += '</div>';
        return html;
    }).join('');

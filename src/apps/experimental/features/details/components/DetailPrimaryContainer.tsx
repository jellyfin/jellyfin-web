...
const DetailPrimaryContainer: FC<DetailPrimaryContainerProps> = ({
    ...
    const { audioStreamIndex, subtitleStreamIndex } = selectedMediaTrackIndices;
    ...
    const {
        ...
        isInstantMixAllowed,
        isShuffleAllowed
    } = getPlaybackCapabilities(item);

    const groupedVersions = useMemo(
        () =>
            getFilteredMediaSources(item.MediaSources || [], MediaSourceType.Grouping),
        [item.MediaSources]
    );

...
function addVirtualFolder(page: Document) {
...
function editVirtualFolder(page: Document, virtualFolder) {
...
function deleteVirtualFolder(page: Document, virtualFolder) {
...
function refreshVirtualFolder(page: Document, virtualFolder) {
...
function renameVirtualFolder(page: Document, virtualFolder) {
...
function showCardMenu(page: Document, elem, virtualFolders: any[]) {
...
function reloadLibrary(page: Document) {
    loading.show();
...
function shouldRefreshLibraryAfterChanges(page: Document) {
    return page.id === 'mediaLibraryPage';
}

function reloadVirtualFolders(page: Document, virtualFolders: any[]) {
    let html = '';
    virtualFolders.push({
...
function editImages(page: Document, virtualFolder) {
...
function getLink(text: string, url: URL) {
...
function getVirtualFolderHtml(page: Document, virtualFolder, index) {
    let html = '';

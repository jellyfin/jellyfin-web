...
function handleSaveUser(
    ...
    return (user: UserDto) => {
        ...
        userPolicy.MaxParentalRating = Number.isNaN(parentalRating)
            ? null
            : parentalRating;
...
const UserParentalControl = () => {
    ...
    const populateRatings = useCallback(
        (allParentalRatings: ParentalRating[]) => {
            let rating;
        ...
        (user: UserDto, allParentalRatings: ParentalRating[]) => {
            ...
            allParentalRatings.forEach((rating) => {
                if (
                    ...
                    user.Policy.MaxParentalRating >= rating.Value
                ) {

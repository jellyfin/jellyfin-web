...
export const REDIRECTS: Redirect[] = [
    ...
    { from: 'useredit.html', to: '/dashboard/users/settings?tab=profile' },
    { from: 'userlibraryaccess.html', to: '/dashboard/users/settings?tab=access' },
    { from: 'userparentalcontrol.html', to: '/dashboard/users/settings?tab=parentalcontrol' },
    { from: 'userpassword.html', to: '/dashboard/users/settings?tab=password' }
];

...
/* eslint-disable indent */
    ...
    function getPagingHtml(startIndex, limit, totalRecordCount) {
        ...
        if (showControls) {
            ...
            html += '<button is="emby-button" title="' + globalize.translate('Previous') + '" class="btnPreviousPage autoSize" ' + (startIndex ? '' : 'disabled') + '><span class="material-icons arrow_back"></span></button>';
            html += '<button is="emby-button" title="' + globalize.translate('Next') + '" class="btnNextPage autoSize" ' + (startIndex + limit >= totalRecordCount ? 'disabled' : '') + '><span class="material-icons arrow_forward"></span></button>';
            html += '</div>';
        }
    ...
    function getRemoteImageHtml(image, imageType, apiClient) {
        ...
        if (enableFooterButtons) {
            ...
            html += '<button is="emby-button" class="btnDownloadRemoteImage autoSize" raised" title="' + globalize.translate('Download') + '"><span class="material-icons cloud_download"></span></button>';
            html += '</div>';
        }

...
const FavoriteButton: FC<FavoriteButtonProps> = ({
    ...
    deprecate('emby-ratingbutton/FavoriteButton', 'Direct ui-primitives/IconButton usage with custom favorite logic', 'src/elements/emby-ratingbutton/FavoriteButton.tsx');

...
function reload(page: Document, item, focusContext ?: any) {
    loading.show();
...
function reloadItem(page: Document, item, apiClient, focusContext) {
    currentItem = item;
...
function renderImages(page: Document, item, apiClient, images, imageProviders, elem) {
    let html = '';
...
function renderStandardImages(page: Document, apiClient, item, imageInfos, imageProviders) {
...
function renderBackdrops(page: Document, apiClient, item, imageInfos, imageProviders) {
    const images = imageInfos.filter(function (i) {
...
function showImageDownloader(page: Document, imageType) {

define(["dialogHelper", "globalize", "connectionManager", "events", "require", "emby-checkbox", "emby-collapse", "css!./style.css"], function (dialogHelper, globalize, connectionManager, events, require) {
    "use strict";

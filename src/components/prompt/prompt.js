define(['browser', 'dialogHelper', 'layoutManager', 'scrollHelper', 'globalize', 'dom', 'require', 'material-icons', 'emby-button', 'paper-icon-button-light', 'emby-input', 'css!components/formdialog'], function (browser, dialogHelper, layoutManager, scrollHelper, globalize, dom, require) {
    'use strict';

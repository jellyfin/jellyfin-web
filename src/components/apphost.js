define(["appSettings", "browser", "events", "htmlMediaHelper"], function(appSettings, browser, events, htmlMediaHelper) {
    ...
    var appHost = {
        ...
        deviceIconUrl: function() {
            return browser.edgeUwp, browser.edgeUwp ? "/web/css/images/devices/windowsrt.png" : browser.opera || browser.operaTv ? "/web/css/images/devices/opera.png" : browser.orsay || browser.tizen ? "/web/css/images/devices/samsungtv.png" : browser.web0s ? "/web/css/images/devices/lgtv.png" : browser.ps4 ? "/web/css/images/devices/ps4.png" : browser.chromecast ? "/web/css/images/devices/chromecast.png" : browser.chrome ? "/web/css/images/devices/chrome.png" : browser.edge ? "/web/css/images/devices/edge.png" : browser.firefox ? "/web/css/images/devices/firefox.png" : browser.msie ? "/web/css/images/devices/internetexplorer.png" : browser.safari ? "/web/css/images/devices/safari.png" : "/web/css/images/devices/html5.png"
        }
    };

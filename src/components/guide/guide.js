...
function Guide(options) {
    ...
    function getChannelProgramsHtml(context, date, channel, programs, renderOptions, listInfo) {
        let html = '';
        ...
        for (let i = listInfo.startIndex, length = programs.length; i < length; i++) {
            ...
            if (displayInnerContent) {
                ...
                if (program.IsHD && renderOptions.showHdIcon) {
                    if (layoutManager.tv) {
    ...
    function renderPrograms(context, date, channels, programs, renderOptions) {
        const listInfo = {
            startIndex: 0
        };
        ...
        for (const channel of channels) {
            html.push(getChannelProgramsHtml(context, date, channel, programs, renderOptions, listInfo));
        }

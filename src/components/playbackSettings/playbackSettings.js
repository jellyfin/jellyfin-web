...
function loadForm(context, user, userSettings, systemInfo, apiClient) {
    ...
    context.querySelector('#selectPreferredTranscodeAudioCodecInVideo').value = appSettings.preferredTranscodeAudioCodecInVideo();
...
function saveUser(context, user, userSettingsInstance, apiClient) {
    ...
    appSettings.preferredTranscodeAudioCodecInVideo(context.querySelector('#selectPreferredTranscodeAudioCodecInVideo').value);

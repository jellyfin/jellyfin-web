...
function loadForm(context, user, userSettings, systemInfo, apiClient) {
    ...
    context.querySelector('#selectPreferredTranscodeAudio').value = appSettings.selectPreferredTranscodeAudio();
...
function saveUser(context, user, userSettingsInstance, apiClient) {
    ...
    appSettings.selectPreferredTranscodeAudio(context.querySelector('#selectPreferredTranscodeAudio').value);

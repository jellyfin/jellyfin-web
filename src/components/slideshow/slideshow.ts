 ...
 */
function getImageUrl(item: object | string, options: object, apiClient: any) {
    options = options || {};
 ...
 */
function getBackdropImageUrl(item: object, options: object, apiClient: any) {
    options = options || {};
 ...
 */
function getImgUrl(item: object, user: any) {
 ...
 */
function getIcon(icon: string, cssClass: string, canFocus: boolean, autoFocus: boolean) {
 ...
 */
function setUserScalable(scalable: boolean) {
    try {
...
export default class Slideshow implements Plugin  {
    ...
    lastMouseMoveData: { x: number; y: number; } | null = null;
    self: this;
     ...
     */
    createElements(slideshowOptions: any) {
     ...
     */
    onZoomChange(swiper: any, scale: any, imageEl: any, slideEl: any) {
     ...
     */
    loadSwiper(dialogElement: HTMLElement, swiperOptions: any) {
        let slides;
     ...
     * @returns {string} The HTML markup of the slide.
     */
    getSwiperSlideHtmlFromItem(item: any) {
     ...
     * @returns {string} The HTML markup of the slide.
     */
    getSwiperSlideHtmlFromSlide(item: any) {
        let html = '';
     ...
     */
    toggleFullscreenButtons(isFullscreen: boolean) {
        const btnFullscreen = dialog.querySelector('.btnFullscreen');
        const btnFullscreenExit = dialog.querySelector('.btnFullscreenExit');
        if (btnFullscreen) {
     ...
     */
    keyframesSlide(hiddenPosition: string, fadingOut: any, element: HTMLElement) {
     ...
     */
    slideToShow(element: HTMLElement, slideFrom: string) {
     ...
     */
    slideToHide(element: HTMLElement, slideInto: string) {
        if (element.classList.contains('hide')) {
            return;
        }
     ...
     */
    getClickHandler(callback?: Function | null) {
        return (e) => {
            showOsd();
            callback?.(e);
        };

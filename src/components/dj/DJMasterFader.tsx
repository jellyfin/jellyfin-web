    ...
    return (
      <div ref={ref} className={DJStyles.crossfader}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ fontSize: '0.75rem', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
            Crossfader
          </div>
          ...
          <div style={{ display: 'flex', gap: '4px', justifyContent: 'center', marginTop: '4px' }}>
            {curves.map(curve => (
              <button
                ...
                style={{
                  padding: '4px 8px',
                  backgroundColor: fxStore.crossfaderCurve === curve ? '#7FBBB3' : '#1A1A1A',
              ...
              >
                {curve === 'logarithmic' ? 'Log' : curve === 'scalecut' ? 'Cut' : 'Lin'}
              </button>
            ))}
          </div>

          {/* Position Readout */}
          <div style={{ textAlign: 'center', fontSize: '0.65rem', color: '#888', fontFamily: 'monospace' }}>

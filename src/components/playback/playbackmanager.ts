...
import {sessionPlayer, chromecastPlayer} from "plugins/types"
const UNLIMITED_ITEMS = -1;

type Player = sessionPlayer | chromecastPlayer;

function enableLocalPlaylistManagement(player: Player) {
...
function supportsPhysicalVolumeControl(player: Player) {
    return player.isLocalPlayer && appHost.supports(AppFeature.PhysicalVolumeControl);
}

function bindToFullscreenChange(player: Player) {
...
function triggerPlayerChange(playbackManagerInstance: PlaybackManager, newPlayer: Player, newTarget, previousPlayer, previousTargetInfo) {
...
function reportPlayback(playbackManagerInstance: PlaybackManager, state, player: Player, reportPlaylist, serverId, method, progressEventName) {
    if (!serverId) {
        // Not a server item
...
function getPlaylistSync(playbackManagerInstance: PlaybackManager, player: Player) {
...
function addPlaylistToPlaybackReport(playbackManagerInstance: PlaybackManager, info, player: Player, serverId) {
...
function getAutomaticPlayers(instance, forceLocalPlayer: boolean) {
    if (!forceLocalPlayer) {
...
async function getPlaybackInfo(player: Player, apiClient, item, deviceProfile, mediaSourceId: string, liveStreamId, options) {
    ...
    type QueryType = {
        ...
        DeviceProfile?: any; // DeviceProfile type
    };
...
function getLiveStream(player: Player, apiClient, item, playSessionId, deviceProfile, mediaSource, options) {
    const postData = {
...
/**
 * @param {import('@jellyfin/sdk/lib/generated-client').PlaybackInfoResponse} result
 */
function validatePlaybackInfoResult(instance: PlaybackManager, result) {
    if (result.ErrorCode) {
...
function getNowPlayingItemForReporting(player: Player, item, mediaSource) {
...
export class PlaybackManager {
    ...
    currentItem: (player: any) => any;
    currentMediaSource: (player: any) => any;
    playMethod: (player: any) => any;
    playSessionId: (player: any) => any;
    getPlayerInfo: () => any;
    setActivePlayer: (player: any, targetInfo: any) => void;
    trySetActivePlayer: (player: any, targetInfo: any) => void;
    getTargets: () => Promise<any[]>;
    playerHasSecondarySubtitleSupport: (player?: any) => boolean;
    trackHasSecondarySubtitleSupport: (track: any, player?: any) => boolean;
    secondarySubtitleTracks: (player?: any) => any[];
    getCurrentSubtitleStream: (player: any, isSecondaryStream?: boolean) => any;
    getSupportedCommands: (player ?: any) => string[];
    getPlayers: () => any[];
    getAutomaticPlayers: (forceLocalPlayer?: boolean) => any[];
    getPlaybackInfo: (player: any, apiClient: any, item: any, deviceProfile: any, mediaSourceId: any, liveStreamId: any, options: any) => Promise<any>;
    getItemsForPlayback: (serverId: string, query: any) => Promise<any>;
    getOptimalMediaSource: (apiClient: any, item: any, versions: any[]) => Promise<any>;
    getLiveStream: (player: any, apiClient: any, item: any, playSessionId: string, deviceProfile: any, mediaSource: any, options: any) => Promise<any>;
    isAutomaticPlayer: (player: any) => boolean;
    getSubtitleStream: (player: any, isSecondaryStream?: boolean) => any;
    getPlaylist: (player?: any) => any[];
    queue: (options: any) => Promise<any>;
    play: (options: any) => Promise<any>;
    syncPlayEnabled: boolean;
    _localPlayPause: () => void;
    _localUnpause: () => void;
    _localPause: () => void;
    _localStop: () => void;
    _localSeek: (position: number) => void;
    _localPlay: (item: any, options?: any) => void;
    _localPlayNext: (item: any, options?: any) => void;
    _localSendCommand: (command: string, data?: any) => void;
    seek: (position: number, player?: any) => void;

    canPlay(item: ItemDto): boolean;
    getPlayerState: (player?: any) => any;
    previousTrack: (player?: any) => void;
    nextTrack: (player?: any) => void;
    promptToSkip: (mediaSegment: MediaSegmentDto, player?: any) => void;


    getController: (player?: any) => any;

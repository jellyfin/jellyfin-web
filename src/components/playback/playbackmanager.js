define(['events', 'datetime', 'appSettings', 'itemHelper', 'pluginManager', 'playQueueManager', 'userSettings', 'globalize', 'connectionManager', 'loading', 'apphost', 'fullscreenManager'], function (events, datetime, appSettings, itemHelper, pluginManager, PlayQueueManager, userSettings, globalize, connectionManager, loading, apphost, fullscreenManager) {
    ...
    /**
     * @param playbackManagerInstance
     * @param newPlayer
     * @param newTarget
     * @param previousPlayer
     * @param previousTargetInfo
     */
     ...
     * @param state
     * @param player
     * @param reportPlaylist
     * @param serverId
     * @param method
     * @param progressEventName
     */
     ...
     * @param directPlayContainers
     * @param maxBitrate
     * @param apiClient
     * @param maxAudioSampleRate
     * @param maxAudioBitDepth
     ...
     * @param liveStreamId
     * @param enableDirectPlay
     * @param enableDirectStream
     * @param allowVideoStreamCopy
     * @param allowAudioStreamCopy
     */
    ...
    function PlaybackManager () {
         ...
         * @param streamInfo
         * @param errorType
         * @param currentlyPreventsVideoStreamCopy
         * @param currentlyPreventsAudioStreamCopy
         */

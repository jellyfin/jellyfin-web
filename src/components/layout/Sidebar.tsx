...
import { Box, Flex, List, ListItem, ListItemButton, Text } from 'ui-primitives';
            ...
            <Box style={{ padding: '1.5rem', borderBottom: `1px solid ${vars.colors.divider}` }}>
                <Flex style={{ alignItems: 'center', gap: '1rem' }}>
                    ...
                    <Box style={{ overflow: 'hidden' }}>
                        <Text weight="bold" noWrap>
                            {user?.Name}
                        </Text>
                        <Text size="xs" color="secondary" noWrap>
                            {globalize.translate('LabelOnline')}
                        </Text>
                    </Box>
                </Flex>
            </Box>

            <Box ref={parentRef} style={{ flexGrow: 1, overflowY: 'auto', padding: '0.5rem 0' }}>
                <List>
                    <ListItem>
                        <Link
                            to="/home"

...
function setLayout(instance: LayoutManager, layout: 'mobile' | 'tv' | 'desktop' | 'experimental', selectedLayout: string) {
...
class LayoutManager {
    ...
    desktop = false;
    experimental = false;
    defaultLayout: 'mobile' | 'tv' | 'desktop' | 'experimental' | undefined;

    setLayout(layout: string, save ?: boolean) {

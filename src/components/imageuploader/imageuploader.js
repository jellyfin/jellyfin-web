define(['dialogHelper', 'connectionManager', 'dom', 'loading', 'scrollHelper', 'layoutManager', 'globalize', 'require', 'emby-button', 'emby-select', 'formDialogStyle', 'css!./style.css'], function (dialogHelper, connectionManager, dom, loading, scrollHelper, layoutManager, globalize, require) {
    'use strict';

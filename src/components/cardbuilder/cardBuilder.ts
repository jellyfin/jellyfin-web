 ...
 */
export function getCardsHtml(items: any, options?: any) {
 ...
 */
function getImageWidth(shape: string, screenWidth: number, isOrientationLandscape: boolean) {
 ...
 */
function getCardTextLines(lines: any[], cssClass: string, forceLines: boolean, isOuterFooter: boolean, cardLayout: any, addRightMargin: boolean, maxLines: number) {
    let html = '';
 ...
 */
function getAirTimeText(item: any, showAirDateTime: boolean, showAirEndTime: boolean) {
    let airTimeText = '';
 ...
 */
function getCardFooterText(item: any, apiClient: any, options: any, footerClass: string, progressHtml: string, flags: any, urls: any) {
    item = item.ProgramInfo || item;
    let html = '';
 ...
 */
function getTextActionButton(item: any, text?: string, serverId?: string) {
    if (!text) {
 ...
 */
function buildCard(index: number, item: any, apiClient: any, options: any) {
 ...
 */
function getHoverMenuHtml(item: any, action: string) {
    let html = '';
 ...
 */
function ensureIndicators(card: HTMLDivElement, indicatorsElem: HTMLDivElement) {
    if (indicatorsElem) {
 ...
 */
function updateUserData(card: HTMLDivElement, userData: any) {
 ...
 */
export function onUserDataChanged(userData: any, scope?: HTMLElement) {
 ...
 */
export function onTimerCreated(programId: string, newTimerId: string, itemsContainer: HTMLElement) {
 ...
 * @param {HTMLElement} itemsContainer - DOM element of the itemsContainer.
 */
export function onTimerCancelled(timerId: string, itemsContainer: HTMLElement) {
 ...
 * @param {HTMLElement} itemsContainer - DOM element of the itemsContainer.
 */
export function onSeriesTimerCancelled(cancelledTimerId: string, itemsContainer: HTMLElement) {

...
const START_PAGE_PATHS = ['/home', '/login', '/selectserver'] as const;
...
class AppRouter {
    ...
    msgTimeout: NodeJS.Timeout | null = null;
    promiseShow: Promise<void> | null = null;
    resolveOnNextShow: CallableFunction | null = null;
    ...
    showItem(item, serverId ?: any, options ?: any) {
    ...
    onRequestFail(_e: Event, data: any) {

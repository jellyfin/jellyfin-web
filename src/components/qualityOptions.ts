...
export interface QualityOptionsArgs {
...
export function getVideoQualityOptions(options: QualityOptionsArgs): QualityOption[] {
...
export function getAudioQualityOptions(options: QualityOptionsArgs): QualityOption[] {
    const maxStreamingBitrate = options.currentMaxBitrate;

...
const meta: Meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Visualizer integration showing how WaveformCell, WaveSurfer, and visualizer controls work together.',
            },
        },
    },
    tags: ['autodocs'],
                ...
                <Box style={{
                    ...
                    <Flex justifyContent="space-between" alignItems="center">
                        <Box>
                            ...
                            <Text size="sm" color="secondary">Artist Name</Text>
                        </Box>
        ...
        return (
            <Box style={{ padding: vars.spacing.lg }}>
                ...
                <Text color="secondary" style={{ marginBottom: vars.spacing.lg }}>
                    Control which visualizer components are active. Each visualizer renders
                    in the visualizer container when enabled.
                </Text>
                ...
                <Box style={{
                    ...
                    <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                        <Flex justifyContent="space-between" alignItems="center" style={{ marginBottom: vars.spacing.sm }}>
                            <Text size="sm" weight="600">Butterchurn</Text>
                            <Toggle
                    ...
                    <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                        <Flex justifyContent="space-between" alignItems="center" style={{ marginBottom: vars.spacing.sm }}>
                            <Text size="sm" weight="600">3D Visualizer</Text>
                            <Toggle
                    ...
                    <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                        <Flex justifyContent="space-between" alignItems="center" style={{ marginBottom: vars.spacing.sm }}>
                            <Text size="sm" weight="600">Frequency Analyzer</Text>
                            <Toggle
                    ...
                    <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                        <Flex justifyContent="space-between" alignItems="center" style={{ marginBottom: vars.spacing.sm }}>
                            <Text size="sm" weight="600">WaveSurfer</Text>
                            <Toggle
                ...
                <Box style={{ marginTop: vars.spacing.xl }}>
                    ...
                    <Box style={{
                        ...
                        {!settings.frequencyAnalyzer && !settings.waveSurfer && (
                            <Text size="sm" color="secondary">Enable a visualizer above to see it here</Text>
                        )}
                    </Box>
                </Box>
            </Box>
            ...
            <Flex direction="column" gap={vars.spacing.lg}>
                <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                    ...
                    <Box style={{
                        ...
                        <Box style={{ padding: vars.spacing.sm, backgroundColor: vars.colors.primary, borderRadius: vars.borderRadius.sm }}>
                            <Text size="xs">Media Element</Text>
                        </Box>
                        <Text size="lg" color="secondary">→</Text>
                        <Box style={{ padding: vars.spacing.sm, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.sm }}>
                        ...
                        <Text size="lg" color="secondary">→</Text>
                        <Box style={{ padding: vars.spacing.sm, backgroundColor: vars.colors.success, borderRadius: vars.borderRadius.sm }}>
                ...
                <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                    ...
                    <Flex direction="column" gap={vars.spacing.sm}>
                        <Flex alignItems="center" gap={vars.spacing.sm}>
                            <Box style={{ width: '120px', padding: vars.spacing.xs, backgroundColor: vars.colors.background, borderRadius: vars.borderRadius.sm }}>
                                <Text size="xs">FrequencyAnalyzer</Text>
                            </Box>
                            <Text size="sm" color="secondary">Connects to: Mixer node for real-time frequency data</Text>
                        </Flex>
                        <Flex alignItems="center" gap={vars.spacing.sm}>
                            <Box style={{ width: '120px', padding: vars.spacing.xs, backgroundColor: vars.colors.background, borderRadius: vars.borderRadius.sm }}>
                                <Text size="xs">Butterchurn</Text>
                            </Box>
                            <Text size="sm" color="secondary">Connects to: Post-gain node for audio-reactive visuals</Text>
                        </Flex>
                        <Flex alignItems="center" gap={vars.spacing.sm}>
                            <Box style={{ width: '120px', padding: vars.spacing.xs, backgroundColor: vars.colors.background, borderRadius: vars.borderRadius.sm }}>
                                <Text size="xs">WaveSurfer</Text>
                            </Box>
                            <Text size="sm" color="secondary">Connects to: MediaElement for waveform extraction</Text>
                        </Flex>
                    </Flex>
                </Box>
                ...
                <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                    ...
                    <Box style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: vars.spacing.md }}>
                        <Box style={{ padding: vars.spacing.sm, backgroundColor: vars.colors.background, borderRadius: vars.borderRadius.sm }}>
                            <Text size="sm" weight="600" style={{ marginBottom: vars.spacing.xs }}>masterAudioOutput</Text>
                            <Text size="xs" color="secondary">Central audio output manager that coordinates the audio chain and provides access to AudioContext, mixer node, and limiter.</Text>
                        </Box>
                        <Box style={{ padding: vars.spacing.sm, backgroundColor: vars.colors.background, borderRadius: vars.borderRadius.sm }}>
                            <Text size="sm" weight="600" style={{ marginBottom: vars.spacing.xs }}>audioStore</Text>
                            <Text size="xs" color="secondary">Zustand store for audio playback state (playing, currentTime, volume, etc.)</Text>
                        </Box>
                        <Box style={{ padding: vars.spacing.sm, backgroundColor: vars.colors.background, borderRadius: vars.borderRadius.sm }}>
                            <Text size="sm" weight="600" style={{ marginBottom: vars.spacing.xs }}>visualizerSettings</Text>
                            <Text size="xs" color="secondary">Global settings for visualizer enabled/disabled state and configuration.</Text>
                        </Box>
                    </Box>
                </Box>
            </Flex>
        ...
        <Box style={{ padding: vars.spacing.lg }}>
            ...
            <Flex direction="column" gap={vars.spacing.lg}>
                <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                    ...
                    <Text size="sm" color="secondary" style={{ marginBottom: vars.spacing.md }}>
                        Visualizer components use React.lazy() to reduce initial bundle size.
                        They are only loaded when enabled in settings.
                    </Text>
                    <Box style={{ padding: vars.spacing.sm, backgroundColor: vars.colors.background, borderRadius: vars.borderRadius.sm }}>
                ...
                <Box style={{ padding: vars.spacing.md, backgroundColor: vars.colors.surface, borderRadius: vars.borderRadius.md }}>
                    ...
                    <Flex direction="column" gap={vars.spacing.sm}>
                        <Flex gap={vars.spacing.sm}>
                            <Box style={{ width: '24px', height: '24px', borderRadius: '50%', backgroundColor: vars.colors.success, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <Text size="xs">✓</Text>
                            </Box>

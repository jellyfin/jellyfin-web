...
function MenuListStory(): ReactElement {
    return (
        <div style={{ width: '250px', border: '1px solid #333', borderRadius: '8px', overflow: 'hidden' }}>
            <ListSubheader>File</ListSubheader>
            <ListItemButton><span>New</span></ListItemButton>
            <ListItemButton><span>Open</span></ListItemButton>
            <ListItemButton><span>Save</span></ListItemButton>
            <ListSubheader>Edit</ListSubheader>
            <ListItemButton><span>Cut</span></ListItemButton>
            <ListItemButton><span>Copy</span></ListItemButton>
            <ListItemButton><span>Paste</span></ListItemButton>
        </div>
    );
}

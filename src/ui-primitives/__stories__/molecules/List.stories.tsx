...
function WithSelectionStory(): ReactElement {
    ...
    const selectNotifications = useCallback((): void => {
        ...
        <div style={{ display: 'flex', gap: '24px' }}>
            <div>
                <List size="sm" style={{ width: '200px' }}>
                    <ListItem>
                        <ListItemButton>
                            <ListItemContent>Small</ListItemContent>
                        </ListItemButton>
                    </ListItem>
                    <ListItem>
                        <ListItemButton>
            ...
            <div>
                <List size="md" style={{ width: '200px' }}>
                    <ListItem>
                        <ListItemButton>
                            <ListItemContent>Medium</ListItemContent>
                        </ListItemButton>
                    </ListItem>
                    <ListItem>
                        <ListItemButton>
            ...
            <div>
                <List size="lg" style={{ width: '200px' }}>
                    <ListItem>
                        <ListItemButton>
                            <ListItemContent>Large</ListItemContent>
                        </ListItemButton>
                    </ListItem>
                    <ListItem>
                        <ListItemButton>
            ...
            <List>
                ...
                <List nested>
                    ...
                    <List nested>
                        ...
                        <ListItem>
                            <ListItemButton>
                                <ListItemContent>This Week</ListItemContent>
                            </ListItemButton>
                        </ListItem>
                    </List>
                    <ListItem>
                        <ListItemButton>
                            <ListItemContent>All Documents</ListItemContent>
                        </ListItemButton>
                    </ListItem>
                </List>
            </List>

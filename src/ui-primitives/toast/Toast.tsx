    ...
    return (
        ...
        >
            <div className={toastContent}>
                ...
                {description !== undefined && description !== '' && <div className={toastDescription}>{description}</div>}
                {action !== undefined && (
...
export function ToastTitle({ children, className }: { readonly children: ReactNode; readonly className?: string }): ReactElement {
    return <div className={`${toastTitle} ${className ?? ''}`}>{children}</div>;
}

export function ToastDescription({ children, className }: { readonly children: ReactNode; readonly className?: string }): ReactElement {
    return <div className={`${toastDescription} ${className ?? ''}`}>{children}</div>;
}

export function ToastAction({ children, onClick }: { readonly children: ReactNode; readonly onClick: () => void }): ReactElement {
    return (

...
/* eslint-disable indent */
    ...
    const JellyfinTextAreaPrototype = Object.create(HTMLTextAreaElement.prototype);
    ...
    JellyfinTextAreaPrototype.createdCallback = function () {
        if (!this.id) {
            this.id = 'jellyfintextarea' + elementId;
            elementId++;
        }
    };

    JellyfinTextAreaPrototype.attachedCallback = function () {
        if (this.classList.contains('jellyfin-textarea')) {
            return;
        }

        this.rows = 1;
        this.classList.add('jellyfin-textarea');
    ...
    document.registerElement('jellyfin-textarea', {
        prototype: JellyfinTextAreaPrototype,
        extends: 'textarea'
    });

...
import './jellyfin-slider.scss';
import 'webcomponents.js/webcomponents-lite';
import '../jellyfin-input/jellyfin-input';

/* eslint-disable indent */

    const JellyfinSliderPrototype = Object.create(HTMLInputElement.prototype);
    ...
    JellyfinSliderPrototype.attachedCallback = function () {
        if (this.getAttribute('data-jellyfinslider') === 'true') {
            return;
        }

        this.setAttribute('data-jellyfinslider', 'true');
     ...
     */
    JellyfinSliderPrototype.enableKeyboardDragging = function () {
     ...
     */
    JellyfinSliderPrototype.setKeyboardSteps = function (stepDown, stepUp) {
    ...
    JellyfinSliderPrototype.setBufferedRanges = function (ranges, runtime, position) {
    ...
    JellyfinSliderPrototype.setIsClear = function (isClear) {
    ...
    JellyfinSliderPrototype.detachedCallback = function () {
    ...
    document.registerElement('jellyfin-slider', {
        prototype: JellyfinSliderPrototype,
        extends: 'input'
    });

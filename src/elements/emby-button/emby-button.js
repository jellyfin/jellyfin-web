define(['browser', 'dom', 'layoutManager', 'shell', 'appRouter', 'apphost', 'css!elements/emby-button/emby-button', 'registerElement'], function (browser, dom, layoutManager, shell, appRouter, appHost) {
    'use strict';

...
import JellyfinButtonPrototype from '../jellyfin-button/jellyfin-button';
...
/* eslint-disable indent */
    ...
    const JellyfinRatingButtonPrototype = Object.create(JellyfinButtonPrototype);

    JellyfinRatingButtonPrototype.createdCallback = function () {
        // base method
    ...
    JellyfinRatingButtonPrototype.attachedCallback = function () {
        // base method
    ...
    JellyfinRatingButtonPrototype.detachedCallback = function () {
        // base method
    ...
    JellyfinRatingButtonPrototype.setItem = function (item) {
        if (item) {
    ...
    document.registerElement('jellyfin-ratingbutton', {
        prototype: JellyfinRatingButtonPrototype,
        extends: 'button'
    });

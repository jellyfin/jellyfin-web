...
/* eslint-disable indent */
    ...
    ScrollerPrototype.createdCallback = function () {
        this.classList.add('jellyfin-scroller');
    };
    ...
    function loadScrollButtons(scroller) {
        import('../jellyfin-scrollbuttons/jellyfin-scrollbuttons').then(() => {
            scroller.insertAdjacentHTML('beforebegin', '<div is="jellyfin-scrollbuttons" class="jellyfin-scrollbuttons padded-right"></div>');
        });
    }
    ...
    document.registerElement('jellyfin-scroller', {

import './jellyfin-toggle.scss';
import 'webcomponents.js/webcomponents-lite';

/* eslint-disable indent */

    const JellyfinTogglePrototype = Object.create(HTMLInputElement.prototype);
    ...
    JellyfinTogglePrototype.attachedCallback = function () {
        if (this.getAttribute('data-jellyfintoggle') === 'true') {
            return;
        }

        this.setAttribute('data-jellyfintoggle', 'true');
    ...
    document.registerElement('jellyfin-toggle', {
        prototype: JellyfinTogglePrototype,
        extends: 'input'
    });

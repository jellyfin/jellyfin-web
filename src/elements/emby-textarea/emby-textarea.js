...
if (Object.getOwnPropertyDescriptor && Object.defineProperty) {
    const descriptor = Object.getOwnPropertyDescriptor(HTMLTextAreaElement, 'value');
    ...
    if (descriptor && descriptor.configurable) {
        ...
        Object.defineProperty(HTMLTextAreaElement, 'value', descriptor);
    }
}

class EmbyTextArea extends HTMLTextAreaElement {
    constructor() {
        super();
        if (!this.id) {

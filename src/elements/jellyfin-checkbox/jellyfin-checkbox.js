...
import './jellyfin-checkbox.scss';
import 'webcomponents.js/webcomponents-lite';

/* eslint-disable indent */

    const JellyfinCheckboxPrototype = Object.create(HTMLInputElement.prototype);
    ...
    JellyfinCheckboxPrototype.attachedCallback = function () {
        if (this.getAttribute('data-jellyfincheckbox') === 'true') {
            return;
        }

        this.setAttribute('data-jellyfincheckbox', 'true');

        this.classList.add('jellyfin-checkbox');

        const labelElement = this.parentNode;
        labelElement.classList.add('jellyfin-checkbox-label');
    ...
    JellyfinCheckboxPrototype.detachedCallback = function () {
    ...
    document.registerElement('jellyfin-checkbox', {
        prototype: JellyfinCheckboxPrototype,
        extends: 'input'
    });

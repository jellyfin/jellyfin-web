...
import './jellyfin-tabs.scss';
import '../../assets/css/scrollstyles.scss';

/* eslint-disable indent */
    const JellyfinTabs = Object.create(HTMLDivElement.prototype);
    const buttonClass = 'jellyfin-tab-button';
    ...
    function initScroller(tabs) {
        ...
        const contentScrollSlider = tabs.querySelector('.jellyfin-tabs-slider');
    ...
    JellyfinTabs.createdCallback = function () {
        if (this.classList.contains('jellyfin-tabs')) {
            return;
        }
        this.classList.add('jellyfin-tabs');
    ...
    JellyfinTabs.refresh = function () {
        if (this.scroller) {
            this.scroller.reload();
        }
    };

    JellyfinTabs.attachedCallback = function () {
        initScroller(this);
    ...
    JellyfinTabs.detachedCallback = function () {
        if (this.scroller) {
    ...
    JellyfinTabs.selectedIndex = function (selected, triggerEvent) {
        const tabs = this;
    ...
    JellyfinTabs.selectNext = function () {
    ...
    JellyfinTabs.selectPrevious = function () {
        const current = getSelectedTabButton(this);
    ...
    JellyfinTabs.triggerBeforeTabChange = function () {
        const tabs = this;

        triggerBeforeTabChange(tabs, tabs.selectedIndex());
    };

    JellyfinTabs.triggerTabChange = function () {
        const tabs = this;
    ...
    JellyfinTabs.setTabEnabled = function (index, enabled) {
        const btn = this.querySelector('.jellyfin-tab-button[data-index="' + index + '"]');
    ...
    document.registerElement('jellyfin-tabs', {
        prototype: JellyfinTabs,
        extends: 'div'
    });

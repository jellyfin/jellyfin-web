...
import './jellyfin-radio.scss';

/* eslint-disable indent */

    const JellyfinRadioPrototype = Object.create(HTMLInputElement.prototype);
    ...
    JellyfinRadioPrototype.attachedCallback = function () {
    ...
    document.registerElement('jellyfin-radio', {
        prototype: JellyfinRadioPrototype,
        extends: 'input'
    });

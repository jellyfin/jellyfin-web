...
export default class TableOfContents {
    ...
    createMediaElement() {
        ...
        tocHtml += '<button is="emby-button" class="autoSize bookplayerButton btnBookplayerTocClose hide-mouse-idle-tv" tabindex="-1"><span class="material-icons bookplayerButtonIcon close"></span></button>';
        tocHtml += '</div>';

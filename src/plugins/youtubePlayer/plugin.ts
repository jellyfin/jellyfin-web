...
function createMediaElement(instance: YoutubePlayer, options) {
...
function clearTimeUpdateInterval(instance: YoutubePlayer) {
...
function onEndedInternal(instance: YoutubePlayer) {
...
function onPlaying(instance: YoutubePlayer, playOptions, resolve) {
    if (!instance.started) {
...
function setCurrentSrc(instance: YoutubePlayer, elem, options) {
...
class YoutubePlayer implements Plugin{
    name: string;
    type: PluginType;
    id: string;
    priority: number;
    ...
    currentYoutubePlayer: YoutubePlayer | null = null;
    videoDialog: HTMLVideoElement | null = null;
    resizeListener: ((e: Event) => void) | null = null;

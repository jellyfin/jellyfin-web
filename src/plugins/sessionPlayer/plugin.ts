...
function sendPlayCommand(apiClient: ApiClient, options, playType) {
...
function sendCommandByName(instance: SessionPlayer, name, options) {
    const command = {
        Name: name
    };
...
async function updatePlaylist(instance: SessionPlayer, queue) {
    const options = {
...
function updateCurrentQueue(instance: SessionPlayer, session) {
...
function processUpdatedSessions(instance: SessionPlayer, sessions, apiClient) {
...
function subscribeToPlayerUpdates(instance: SessionPlayer) {
    instance.isUpdating = true;
...
class SessionPlayer implements Plugin {
    name: string;
    type: PluginType;
    id: string;
    isLocalPlayer: boolean;
    playerListenerCount: number;
    playlist: any[];
    isPlaylistRendered: boolean;

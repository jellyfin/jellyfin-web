...
class HtmlAudioPlayer {
    constructor() {
        ...
        function onPlaying(e) {
            ...
            // Only log gap if it's a crossfade transition (elapsed time < 10s)
            const elapsedTime = performance.now() - xDuration.t0;
            const gapSeconds = (elapsedTime / 1000) - xDuration.sustain;

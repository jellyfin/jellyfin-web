...
function tryRemoveElement(elem: HTMLElement) {
...
function enableNativeTrackSupport(mediaSource: MediaSource, track: unknown ) {
...
function requireHlsPlayer(callback: () => any) {
...
function getMediaStreamVideoTracks(mediaSource: MediaSource) {
    return mediaSource.MediaStreams.filter(function (s) {
        return s.Type === 'Video';
    });
}

function getMediaStreamAudioTracks(mediaSource: MediaSource) {
    return mediaSource.MediaStreams.filter(function (s) {
        return s.Type === 'Audio';
    });
}

function getMediaStreamTextTracks(mediaSource: MediaSource) {
    return mediaSource.MediaStreams.filter(function (s) {
        return s.Type === 'Subtitle';
    });
}

function zoomIn(elem: HTMLElement) {
    return new Promise(resolve => {
        const duration = 240;
...
export class HtmlVideoPlayer implements Plugin {
    name: string;
    ...
    #currentTrackOffset: number | undefined;
    #secondaryTrackOffset: number | undefined;
    ...
    /**
         * @private
         */
    setSrcWithFlvJs(elem: HTMLVideoElement, options: any, url: string) {
    ...
    isShowingSubtitleOffsetEnabled(): boolean | undefined {
    ...
    /**
         * @private
         */
    _setSubtitleOffset(offset: number) {
    ...
    /**
         * @private
         */
    updateCurrentTrackOffset(offsetValue: number, currentTrackIndex = PRIMARY_TEXT_TRACK_INDEX) {
    ...
    /**
         ...
         */
    requiresHidingActiveCuesOnOffsetChange(): boolean {
    ...
    /**
         * @private
         */
    hideTextTrackWithActiveCues(currentTrack: TextTrack) {
    ...
    /**
         ...
         * @private
         */
    forceClearTextTrackActiveCues(currentTrack: TextTrack) {
        if (currentTrack.activeCues) {
    ...
    /**
         * @private
         */
    setTextTrackSubtitleOffset(currentTrack: TextTrack, offsetValue: number, currentTrackIndex: number) {
    ...
    /**
         * @private
         */
    setTrackEventsSubtitleOffset(trackEvents: any[], offsetValue: number, currentTrackIndex: number) {
    ...
    isPrimaryTrack(textTrackIndex: number): boolean {
        return textTrackIndex === PRIMARY_TEXT_TRACK_INDEX;
    }

    isSecondaryTrack(textTrackIndex: number): boolean {
    ...
    /**
         * @private
         */
    isAudioStreamSupported(stream: any, deviceProfile: any, container: string): boolean {
    ...
    /**
         * @private
         */
    ensureValidVideo(elem: HTMLVideoElement) {
    ...
    /**
         * @private
         */
    destroyCustomRenderedTrackElements(targetTrackIndex: number) {
    ...
    /**
         * @private
         */
    destroyNativeTracks(videoElement: HTMLVideoElement, targetTrackIndex: number) {
        if (videoElement) {
    ...
    /**
         * @private
         */
    destroyStoredTrackInfo(targetTrackIndex: number) {
        if (this.isPrimaryTrack(targetTrackIndex)) {
    ...
    /**
         * @private
         */
    destroyCustomTrack(videoElement: HTMLVideoElement, targetTrackIndex: number) {
    ...
    /**
         * @private
         */
    fetchSubtitlesUwp(track: any): Promise<any> {
    ...
    /**
         * @private
         */
    async fetchSubtitles(track: any, item: any): Promise<any> {
    ...
    /**
         * @private
         */
    setTrackForDisplay(videoElement: HTMLVideoElement, track: any, targetTextTrackIndex = PRIMARY_TEXT_TRACK_INDEX) {
        if (!track) {
    ...
    /**
         * @private
         */
    renderSsaAss(videoElement: HTMLVideoElement, track: any, item: any) {
    ...
    /**
         * @private
         */
    requiresCustomSubtitlesElement(userSettings: any): boolean {
    ...
    /**
         * @private
         */
    renderSubtitlesWithCustomElement(videoElement: HTMLVideoElement, track: any, item: any, targetTextTrackIndex: number) {
    ...
    /**
         * @private
         */
    setSubtitleAppearance(elem: HTMLElement, innerElem: HTMLElement) {
    ...
    /**
         * @private
         */
    getCueCss(appearance: any, selector: string): string {
        return `${selector}::cue {
    ...
    /**
         * @private
         */
    async renderTracksEvents(videoElement: HTMLVideoElement, track: any, item: any, targetTextTrackIndex = PRIMARY_TEXT_TRACK_INDEX): Promise<void> {
    ...
    /**
         * @private
         */
    updateSubtitleText(timeMs: number) {
     ...
     * @private
     */
    supportsPlayMethod(playMethod: string, item: any): boolean {
     ...
     * @private
     */
    static getDeviceProfileInternal(item: any, options: any): Promise<any> {
    ...
    static onPictureInPictureError(err: any) {
        console.error(`Picture in picture error: ${err}`);
    }

    setPictureInPictureEnabled(isEnabled: boolean) {
        const video = this.#mediaElement;
    ...
    setAirPlayEnabled(isEnabled: boolean) {
        const video = this.#mediaElement;
    ...
    getSupportedPlaybackRates() {
        return [{
            ...
            name: '4.0x',
            id: 4.0
        }] as const; // TypeScript type for playback rate options
    }
    ...
    getSupportedAspectRatios(): { name: string; id: string }[] {
        return [{

...
export default class ConnectionManager {
    ...
    clearData: () => void;
    _getOrAddApiClient: (server: any, serverUrl: string) => ApiClient;
    getOrCreateApiClient: (serverId: string) => ApiClient;

    user: (apiClient: ApiClient) => Promise<{ localUser: any; name: string | null; imageUrl: string | null; supportsImageParams: boolean }>;
    logout: () => Promise<void>;
    getSavedServers: () => any[];
    getAvailableServers: () => Promise<any[]>;
    connectToServers: (servers: any[], options?: any) => Promise<{ Servers: any[]; State: ConnectionState }>;
    connectToServer: (server: any, options?: any) => Promise<{ Servers: any[]; State: ConnectionState; ApiClient?: ApiClient; SystemInfo?: any }>;
    connectToAddress: (address: string, options?: any) => Promise<{ State: ConnectionState; ApiClient?: ApiClient }>;
    deleteServer: (serverId: string) => Promise<void>;
    handleMessageReceived: (msg: any) => void;
    getApiClients: () => ApiClient[];
    getApiClient: (item: any) => ApiClient;
    minServerVersion: (val?: string) => string;
    onLocalUserSignedIn: ((user: any) => Promise<void>) | null = null;
    onLocalUserSignedOut: ((logoutInfo: { serverId: string }) => void) | null = null;
